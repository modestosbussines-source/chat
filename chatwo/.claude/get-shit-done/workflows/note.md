...
- **Global scope**: `C:/Users/Igor/Documents/chatwo/chatwo/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/Igor/Documents/chatwo/chatwo/.claude/notes/`)
...
2. Glob `C:/Users/Igor/Documents/chatwo/chatwo/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/Igor/Documents/chatwo/chatwo/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/Igor/Documents/chatwo/chatwo/.claude/notes/` — works in any directory
