  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        default: 'border-transparent bg-zinc-800/20 text-zinc-300 light:bg-zinc-200 light:text-zinc-700',
        ...
        success: 'border-transparent bg-zinc-800/20 text-zinc-300 light:bg-zinc-200 light:text-zinc-700',
