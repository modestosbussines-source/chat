...
![Templates](/omni/images/11-templates.png)

## Overview

WhatsApp Message Templates are pre-approved message formats that allow businesses to send notifications and updates to customers. Omni makes it easy to manage, sync, and use templates across your organization.
...
![Template Editor](/omni/images/12-template-editor.png)
...
- Omni automatically detects whether your template uses positional or named parameters
