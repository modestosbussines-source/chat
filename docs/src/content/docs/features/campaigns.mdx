...
![Campaigns](/omni/images/13-campaigns.png)

## Overview

Campaigns allow you to send bulk WhatsApp messages to multiple contacts at once. Whether you're sending promotional offers, updates, or notifications, Omni handles the delivery efficiently while respecting WhatsApp's rate limits.
...
![Campaign Details](/omni/images/14-campaign-details.png)
