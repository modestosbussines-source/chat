...
Omni receives webhooks from Meta's WhatsApp Business API and processes them automatically. You can also configure your own webhook endpoints to receive notifications about message events.

## Meta Webhook Configuration

Omni exposes webhook endpoints that you configure in your Meta App settings:
...
Omni handles this verification automatically.
...
Meta may send webhooks at high volumes during campaigns. Omni:
